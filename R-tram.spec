...
Version  : 1.0.6
Release  : 24
URL      : https://cran.r-project.org/src/contrib/tram_1.0-6.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tram_1.0-6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726696026
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/tram/libs/tram.so
/V4/usr/lib64/R/library/tram/libs/tram.so
